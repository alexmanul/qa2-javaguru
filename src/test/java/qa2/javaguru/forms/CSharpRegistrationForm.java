...
public class CSharpRegistrationForm implements RegistrationForm {
    private static final Logger LOGGER = Logger.getLogger(CSharpRegistrationForm.class);
    public static final By DISCOUNT = By.id("entry_337407387");
    private BaseFunctions baseFunctions;

    public CSharpRegistrationForm(BaseFunctions baseFunctions) {
