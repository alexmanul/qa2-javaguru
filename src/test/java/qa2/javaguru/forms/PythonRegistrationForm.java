...
public class PythonRegistrationForm implements RegistrationForm {

    private static final Logger LOGGER = Logger.getLogger(PythonRegistrationForm.class);
    public static final By DISCOUNT = By.id("entry_337407387");
    private BaseFunctions baseFunctions;

    public PythonRegistrationForm(BaseFunctions baseFunctions) {
        this.baseFunctions = baseFunctions;
        LOGGER.info("Registration form is loaded");
    }

    public void fillRegistrationForm(String firstName, String lastName, String phone, String email, String skills, String comment, String discount) {
