...
import qa2.javaguru.pages.CSharpPage;
import qa2.javaguru.pages.MainPage;

public class RegistrationTestCSharp {
    ...
    public void registrationTesting() {
        CSharpPage cSharpPage = mainPage.openCSharpPage();
        CSharpRegistrationForm cSharpRegistrationForm = cSharpPage.openRegistrationForm();
        baseFunctions.switchingTabs();
        cSharpRegistrationForm.fillRegistrationForm(FIRST_NAME, LAST_NAME, PHONE, EMAIL, SKILLS, COMMENT, DISCOUNT);
    }
